...
public class BST {
    ...
    /*
     * Keeps track of the balance factor of each node
     */
//    public void bFactor(BST node) {
//        if(node.isLeaf()) {
//            node.balancefactor= 0;
//        } else if (node.getLeftChild().isEmpty() && !node.getRightChild().isEmpty()) {
//            node.balancefactor= node.getRightChild().getHeight();
//        } else if (node.getRightChild().isEmpty() && !node.getLeftChild().isEmpty()) {
//            node.balancefactor= -(node.getLeftChild().getHeight());
//        } else if (!node.getLeftChild().isEmpty() && !node.getRightChild().isEmpty()) {
//            node.balancefactor= node.getRightChild().getHeight()- node.getLeftChild().getHeight();
//        }
//    }
//
//
